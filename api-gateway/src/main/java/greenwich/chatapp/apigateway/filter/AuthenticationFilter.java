...
import greenwich.chatapp.apigateway.exception.ValidationException;
import greenwich.chatapp.apigateway.response.VerifyTokenResponse;
...
public class AuthenticationFilter implements GatewayFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        Integer status = verifyTokenResponse.getStatus();
        String message = verifyTokenResponse.getMessage();
        String xUserToken = verifyTokenResponse.getXUserToken();
